...
| -------------------- | -------- | --------- | ----------- | ------------- | ---------- | -------- |
| `bail_anticipatory`  | **keep** | 1.00      | 1.00        | 0.43          | 1.00       | 0.33     |
| `bail_regular`       | **keep** | 1.00      | 1.00        | 0.43          | 1.00       | 0.33     |
| `consumer_complaint` | **keep** | 1.00      | 1.00        | 0.43          | 0.88       | 0.67     |
| `legal_notice_s138`  | **keep** | 1.00      | 1.00        | 0.86          | 0.63       | 0.33     |
| `legal_notice_s80`   | **keep** | 1.00      | 1.00        | 0.86          | 0.63       | 0.33     |
| `rent_agreement`     | **keep** | 1.00      | 1.00        | 0.80          | 0.63       | 0.33     |
...
- doc_structure (drift 0.43): 4/7 section ids shared
...
- doc_structure (drift 0.86): 1/7 section ids shared
...
- doc_structure (drift 0.80): 1/5 section ids shared
- validation_rules (drift 0.63): allowed=1.00 reject=0.00 mandatory=1.00 flags=0.50
