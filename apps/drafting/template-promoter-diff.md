...
| -------------------- | -------- | --------- | ----------- | ------------- | ---------- | -------- |
| `bail_anticipatory`  | **keep** | 1.00      | 1.00        | 1.00          | 1.00       | 0.33     |
| `bail_regular`       | **keep** | 1.00      | 1.00        | 1.00          | 1.00       | 0.33     |
| `consumer_complaint` | **keep** | 1.00      | 1.00        | 1.00          | 0.88       | 0.67     |
| `legal_notice_s138`  | **keep** | 1.00      | 1.00        | 1.00          | 0.63       | 0.33     |
| `legal_notice_s80`   | **keep** | 1.00      | 1.00        | 1.00          | 0.63       | 0.33     |
| `rent_agreement`     | **keep** | 1.00      | 1.00        | 1.00          | 0.63       | 0.33     |
...
- doc_structure (drift 1.00): override has 7 sections, promoter has 0
...
- doc_structure (drift 1.00): override has 5 sections, promoter has 0
...
- doc_structure (drift 1.00): override has 4 sections, promoter has 0
- validation_rules (drift 0.63): allowed=1.00 reject=0.00 mandatory=1.00 flags=0.50
